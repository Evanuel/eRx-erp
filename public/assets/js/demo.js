...
$(".rightSetting .btn-theme-light").on("click", function () {
    $("body").removeClass("dark theme-black submenu-closed menu_dark logo-black");
    $("body").addClass("theme-black submenu-closed logo-white");
    var theme="";
    var menu_option = "";
    localStorage.setItem("choose_logoheader", "logo-white");
    ...
    $("body").removeClass("theme-black submenu-closed logo-white");
    $("body").addClass("dark theme-black submenu-closed menu_dark logo-black");
